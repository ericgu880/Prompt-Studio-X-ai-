...
bash "$ROOT_DIR/Scripts/test_batch_media_import.sh"
bash "$ROOT_DIR/Scripts/test_folder_multiselect_drag.sh"
bash "$ROOT_DIR/Scripts/test_prompt_composer_simplification.sh"
