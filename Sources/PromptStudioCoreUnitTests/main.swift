...
do {
    ...
    try testCapturedCreateAndDuplicateAvoidFullItemHydration()
    try testAutomationCreateTextAndImageAvoidFullItemHydration()
    ...
    try testItemDetailControllerPhase2A3()
    try testItemDetailCacheBoundsAndRevision()
    try testItemDetailCacheConservativeCost()
    try testItemDetailCacheTokensAndBoundedMetadata()
    try testItemDetailCacheConcurrentAccess()
    try await runItemDetailControllerTests()
    try testLibraryStatisticsUseDirectAggregates()
    try testPromptRepositoryThumbnailPathBatchIsAtomicAndSkipsTags()
    try await testThumbnailPathBatcherFlushesAtFiftyAndSupportsFlushCancel()
    try await testThumbnailPathBatcherCancelAndWaitSettlesRunningHandler()
    try await testThumbnailPathBatcherSerializesReentrantSameIDAndUsesLatestPath()
    try await testThumbnailPathBatcherHandlerEnqueueRegistersSuccessorWithoutDeadlock()
    try await testThumbnailPathBatcherHandlerCancelAndWaitSkipsCurrentTaskWithoutDeadlock()
    try await testThumbnailPathBatcherInheritedLegacyChildPreservesPhysicalCancelBarrier()
    try await testThumbnailPathBatcherHandlerFlushSkipsCurrentTaskWithoutDeadlock()
    try await testThumbnailPathBatcherInheritedLateChildDoesNotStickSuccessorPending()
    try await testThumbnailPathBatcherDetachedHandlerEnqueueSkipsCurrentTaskWithoutDeadlock()
    try await testThumbnailPathBatcherDetachedHandlerCancelAndWaitSkipsCurrentTaskWithoutDeadlock()
    try await testThumbnailPathBatcherDetachedHandlerFlushSkipsCurrentTaskWithoutDeadlock()
    try testPromptRepositoryFolderMutationsAdvanceSharedRevisionAndPublishRenameIDs()
    try testPromptRepositoryMissingFolderMutationsDoNotAdvanceSharedRevision()
    try testPromptRepositoryBatchFolderOrderAdvancesOneSharedRevision()
    try testPromptRepositoryNoOpFolderMutationsDoNotAdvanceSharedRevision()
    try await testThumbnailPathBatcherRetriesAutomaticTimerFailureUntilSuccess()
    try await testThumbnailPathBatcherStopsAutomaticRetryAfterBoundedExhaustion()
    try await testThumbnailPathBatcherExplicitFlushStillThrowsWithoutAutomaticRetry()
    try await runMediaImportServiceTests()
    try await runSQLiteReadCancellationTests()
    ...
    try testLibraryQueryCursorRoundTripAndFingerprint()
    try testLibraryItemSummaryHasOnlyLightweightFields()
    try testLibraryQueryScopesAndTagUnsupported()
    try testLibraryItemPageUsesTypedCursors()
    try testLibraryQuerySQLBuilderUsesKeysetPaginationAndBoundValues()
    try testLibraryQuerySQLBuilderRefusesUnreadyVersionSummary()
    try await testLibraryQueryCurrentVersionGoldenEqualCreatedAt()
    try await testLibraryQuerySummaryUsesLegacyCurrentVersionOnly()
    try await testInMemoryFilteringUsesLegacyCurrentVersionAndDecodedReferences()
    try await testLibraryQuerySummaryUsesSwiftWhitespaceSemantics()
    try await testLibraryQuerySummaryReferencesMatchLegacyDecodeFallback()
    try testLibraryQuerySQLBuilderSemanticFunctionsAreExplicit()
    try testLibraryQuerySummaryLatestVersionIndexExplain()
    try testPromptVersionSequenceMigrationAddsSchemaAndGoldenOrder()
    try testItemSequenceSummaryFailsClosedBeforeReady()
    try await testItemCreatedAtCompatibilityFreezeReadySummaryUsesPersistedDate()
    try await testItemCreatedAtCompatibilityFreezeSummaryMatchesDetail()
    try await testItemCreatedAtCompatibilityFreezeDetailGateSwitchesOnSameService()
    try await testItemCreatedAtCompatibilityFreezeControllerDropsPreReadyCache()
    try await testItemCreatedAtCompatibilityFreezeControllerReloadsSelectedHubEvent()
    try testItemCreatedAtCompatibilityFreezeReadyEditPreservesRawCreatedAtAndSortKey()
    try testItemCreatedAtCompatibilityFreezeReadyEditPreservesTagRelationRawCreatedAt()
    try testItemCreatedAtCompatibilityFreezeParserRequiresStrictRFC3339FullMatch()
    try testItemCreatedAtCompatibilityFreezeExactFractionSortKeyRounding()
    try await testItemCreatedAtCompatibilityFreezeReadySummaryFailsClosedOnEveryMetadataField()
    try await testItemCreatedAtCompatibilityFreezeRepositoryQueryServiceRefreshesCapabilitiesAfterMigration()
    try await testItemCreatedAtCompatibilityFreezeUsesDeterministicObservationClockAndPreservesRawFields()
    try testPromptRepositoryLegacyObservationClockControlsPreReadyLoadItemsAndMatchesMigration()
    try testPromptRepositoryLegacyObservationClockExhaustionFailsClosedAndInstancesDoNotShare()
    try testPromptRepositoryLegacyObservationClassificationMatchesItemMigration()
    try testPromptRepositoryLegacyLenientCreatedAtValuesStayMigrationCompatible()
    try await testItemCreatedAtCompatibilityFreezePreReadySummaryFailsClosed()
    try await testItemCreatedAtCompatibilityFreezeMicrosecondRoundTripAndOrdering()
    try testItemCreatedAtCompatibilityFreezeMicrosecondHelperRangeAndPrecision()
    try testItemSequenceMigrationPreservesEqualKeyInsertionOrder()
    try testItemSequenceMigrationPreservesReverseEqualKeyInsertionOrder()
    try testItemSequenceMigrationPublishesInvalidationAfterLockForReentrantWriter()
    try testItemSequenceStaticRollbackInvalidatesHubAfterClosedReservationReleases()
    try testItemSequenceStaticRollbackRejectsLiveCustomHubRepository()
    try testItemSequenceTimestampFallbackIsPersisted()
    try testItemSequenceTimestampOraclePreservesDateSemanticsAndRawFields()
    try testItemSequenceWritersPreserveAndAllocateGlobalOrder()
    try testItemSequenceMigrationResumesAfterWriterAndIsIdempotent()
    try testItemSequenceBackfillKeepsLegacyLoaderAndFilterOrderUntilReady()
    try testItemSequenceMigrationReconcilesLegitimateRelatedTagMutationBetweenBatches()
    try testItemSequenceMigrationRejectsDirectSQLDriftAfterCheckpointReconciliation()
    try testItemSequenceConcurrentRepositoriesAllocateUniqueGlobalSequences()
    try await testItemSequenceConcurrentPrepareCoalescesOneBackup()
    try testItemSequenceFingerprintScansAreBoundedAcrossManyBatches()
    try testItemSequenceHistoricalMaxScanCountIsBoundedAcrossBatches()
    try testItemSequenceReadinessRejectsMissingIndexAndTriggerContract()
    try testItemSequenceReadinessRejectsExtraIndexPredicateAndTriggerSemantics()
    try testItemSequenceFinalizeRejectsCorruptMetadata()
    try testItemSequenceReadySurvivesReopenVacuumAndRuntimeProbe()
    try testItemSequenceReadyLegacyLoaderAndFilterSnapshotUsePersistedOrderAfterReopen()
    try testItemSequenceReadyComparatorsIgnoreRawDateWhenPersistedKeysTie()
    try testItemSequenceAllocatorFailsClosedAtInt64Maximum()
    try testItemSequenceProvisionalAllocatorFailsClosedAtInt64Maximum()
    try testItemSequenceRollbackRejectsPostBackupBusinessAndRelatedMutations()
    try testItemSequenceRollbackRejectsWriterDuringBackfillAndPreservesWriter()
    try testItemSequenceBackfillMutationMatrixReconcilesWritersAndFields()
    try testItemSequenceReadyExplainMatrixUsesPersistedIndexesForPageAndCount()
    try testItemSequenceOnlineBackupClonePreservesReadyOrder()
    try testItemSequenceRollbackRejectsLaterVersionOrTagMigrationState()
    try testItemSequenceRecentOrderingMatchesLegacyDateOracleForNoncanonicalRawValues()
    try testItemSequenceReadySQLNeverEmitsLegacyTieOrdering()
    try testItemSequenceCapabilityMustBeExplicit()
    try testItemSequenceReadyIndexesAndTagOrderContract()
    try testItemSequenceRollbackRejectsIndependentReadConnectionLease()
    try testPromptVersionSequenceMigrationResumesWithCheckpointAndIsIdempotent()
    try await testPromptVersionSequenceConcurrentPrepareCoalescesOneBackup()
    try testPromptVersionSequenceRejectsNegativeMaxBatchesAndZeroIsNoOp()
    try testPromptVersionSequenceBackfillWriterBetweenBatchesKeepsReadyMetadata()
    try testPromptVersionSequenceRollbackRejectsWriterDuringBackfillAndPreservesWriter()
    try testPromptVersionSequenceBackfillWriterCanDeleteVersionBetweenBatches()
    try testPromptVersionSequenceMigrationRejectsUnreconciledExternalDrift()
    try testPromptVersionSequenceRollbackRejectsExternalVersionWriteAndPreservesLiveBytes()
    try testPromptVersionSequenceInstanceRollbackAlwaysRejectsUnsafeWholeFileRestore()
    try testPromptVersionSequenceFinalizeRejectsPreTriggerCorruptMetadata()
    try testPromptVersionSequenceWriterUsesDirtyMarkerWithoutRescanningFingerprint()
    try testPromptVersionSequenceReadyRejectsInvalidSequenceTypeAndRange()
    try testPromptVersionSequenceMigrationDetectsDeleteReinsertRowOrderDrift()
    try testPromptVersionSequenceMigrationAuditsNonCanonicalDatesWithoutRewritingCreatedAt()
    try testPromptVersionSequenceMigrationUsesDeterministicObservationClock()
    try await testPromptVersionSequenceMigrationEnforcesUniqueSequenceAndConcurrentWrites()
    try testPromptVersionSequenceRuntimeSQLUsesPersistentKeys()
    try await testPromptVersionSummaryRefusesPreReadyTimestampFallbackAndMatchesReadyDateOrder()
    try await testPromptVersionSequenceMigrationPreservesNoVersionSummaryProjection()
    try testPromptVersionSequenceExistingVersionEditPreservesSequenceAndCreatedAt()
    try testPromptVersionSequencePrependingNewVersionAllocatesAfterOldMax()
    try await testPromptVersionSequenceMigrationPreserves500VersionDetailOrder()
    try await testPromptVersionDetailCachedServiceSwitchesToPersistedOffsetAndFractionalOrder()
    try await testPromptVersionDetailPreReadySuppressesMetadataAndMatchesBackfillPrependLegacyOrder()
    try await testPromptVersionDetailReadsReadyGateOncePerRequest()
    try testPromptVersionSequenceRollbackRestoresLegacySchemaAndState()
    try testPromptVersionSequenceRollbackRejectsTagMigrationDrift()
    try testTagRelationRollbackRejectsVersionMigrationDrift()
    try testTagRelationRollbackRejectsExternalBusinessWriteAndPreservesLiveBytes()
    try testPromptVersionSequenceReadyRejectsSpoofedMetadata()
    try testPromptVersionSequenceReadyRejectsNonUniqueOrWrongOrderIndexes()
    try await testSQLiteQueryPreservesEmbeddedNULText()
    try testPromptVersionSequenceReadyRejectsDirectNullMetadataAndPreReadyIndexInstall()
    try testPromptVersionSequenceFactoryAutomaticallyOpensReadyCapability()
    try testPromptVersionSequenceMigrationFailureKeepsDatabaseOnRestoreSourceError()
    try testSQLiteRestoreFirstMoveFailurePreservesLiveBytes()
    try testLibraryQuerySQLBuilderCursorFingerprintMismatchIsRejected()
    try testLibraryQuerySQLBuilderKeysetKeepsRowsWithEqualSortKeys()
    try testLibraryQuerySQLBuilderFirstPageHasNoPseudoCursorPredicate()
    try testLibraryQuerySQLBuilderRejectsCursorWithoutOrderingKey()
    try testLibraryQuerySQLBuilderCountUsesSameFilterWithoutPagination()
    try testLibraryQueryRevisionInvalidatesExistingCursor()
    try testLibraryQueryPhase2A1IndexesAreExplicitAndExplainable()
    try await testLibraryQueryServiceTrimsExtraRowAndBuildsNextCursor()
    try await testLibraryQueryServiceRefusesUnreadyVersionSummary()
    try await testLibraryQueryServiceExactPageHasNoCursor()
    try await testLibraryQueryServiceGenerationGuardRejectsStaleResultsWithoutCancellation()
    try await testLibraryQueryServiceUsesRealSQLiteForKeysetBoundaries()
    try await testLibraryQueryServiceKeysetBoundariesAcrossAllShapes()
    try await testLibraryQueryServiceUsesIndependentReadConnection()
    try await testLibraryQueryServiceSQLiteWitnessUsesOneReadSnapshot()
    try await testLibraryQueryServiceSQLiteSnapshotSurvivesDeleteCommit()
    try await testLibraryQueryServiceSQLiteSnapshotSurvivesFavoriteCommit()
    try await testLibraryQueryServiceSQLiteSnapshotSurvivesFolderMoveCommit()
    try await testLibraryQueryServiceSQLiteSnapshotSurvivesTrashCommit()
    try await testLibraryQueryServiceSQLiteSnapshotSurvivesRestoreCommit()
    try await testLibraryQuerySessionCancelsPreviousRequest()
    try await testLibraryQueryServicePreservesRawFractionalCursorKeys()
    try await testLibraryQueryCursorRequiresRestartAfterDeleteInsertAndReorder()
    try await testLibraryQueryServiceUsesOneReadSnapshotForPageAndCount()
    try await testLibraryQueryServiceAutomaticallyRejectsCursorAfterRevisionAdvance()
    try await testLibraryQueryServiceRejectsSnapshotWhenRevisionChangesDuringRead()
    try await testLibraryBrowserStateRealSQLitePagesAndShadowParity()
    try await testLibraryBrowserStateReadyBoundaryMatrixParity()
    try await testLibraryBrowserStateRevisionInvalidatesRealSQLiteCursor()
    try await testLibraryBrowserStateRealSQLiteRapidSwitchCancellation()
    try await testLibraryBrowserStateSynchronousCancelInterruptsSQLiteAndDoesNotCancelReplacement()
    try await testLibraryBrowserStateSynchronousCancelImmediatelyFollowedByReplacement()
    try await testLibraryBrowserStateCancelAndWaitInterruptsActiveSQLiteRequest()
    try await testLibraryBrowserStateAwaitedRevisionInterruptsActiveSQLiteRequest()
    try await testLibraryQuerySessionCancelledCallerCannotCancelNewerRequest()
    try await testLibraryBrowserStateUnsupportedFilterAndRetryContract()
    try await testLibraryBrowserStateReplaceAppendRaceAndAtomicDisplay()
    try await testLibraryBrowserStateSameQueryRefreshCommitsNewGeneration()
    try await testLibraryBrowserStateInitialFailureRetryAndRevisionDuringInitial()
    try await testLibraryBrowserStateFailedReplacementPreservesDisplayAndRetriesExactQuery()
    try await testLibraryBrowserStateUnsupportedFiltersDoNotInvokeExecutor()
    try await testLibraryBrowserStateShadowRejectsLaterPageCountDrift()
    try await testLibraryBrowserStateConcurrentAppendCoalescesOneExecutorCall()
    try await testLibraryBrowserStateExactCursorTokenRoundTrip()
    try await testLibraryBrowserStateDecodedCursorExecutesContinuationThroughSession()
    try await testLibraryBrowserStateRevisionSynchronizationInvalidatesCursorImmediatelyAndAwaited()
    try testLibraryQueryTagSQLGateClosedByDefaultAndOpenWithExplicitCapability()
    try await testLibraryQueryTagServiceGateClosedByDefault()
    try testLibraryQueryTagSQLPreservesExactNamesAndRefinements()
    try testLibraryQueryTagSQLUsesRelationKeysetCursorAndMatchingCount()
    try await testLibraryQueryTagServiceReturnsExactNameOnceAndSupportsKeysetPages()
    try await testLibraryQueryTagServiceAppliesTypeModelFavoriteAndRevisionCursorGuard()
    try await testLibraryQueryTagExplainUsesRelationIndexWithoutPromptItemScan()
    try await testLibraryQueryTagCursorInvalidatesAfterRepositoryTagMutation()
    try testReadOnlyOnlineBackupPreservesSourceBytesAndCopiesWALState()
    try testTagRelationMigrationResumesAndPreservesExactNameIdentity()
    try testTagRelationMigrationRejectsNegativeMaxBatches()
    try testTagRelationDualWriteCoversSaveDeleteRestoreRenameAndTagDelete()
    try testTagRelationMigrationFailureKeepsLegacyJSONAndGateClosed()
    try testTagRelationMigrationRejectsMalformedJSONAndKeepsSourceUntouched()
    try testTagRelationMigrationHandles15959KeysetRows()
    try testItemDetailInvalidationHubSharesByCanonicalLibraryAndCancels()
    try testItemDetailInvalidationHubRevisionIsMonotonicAndLibrariesAreIsolated()
    try testPromptRepositoryPublishesCommittedItemDetailInvalidations()
    try testSaveCapturedItemPublishesAfterUnlockAndSupportsReentrantObserver()
    try testPromptRepositoryPlaceholderMigrationPublishesOnlySuccessfulIDs()
    try testTagRelationMirrorSurvivesAllPromptItemMutationPaths()
    try await runItemDetailServiceTests()
